...
if (createTourForm) createTourForm.addEventListener('submit', function (e) {
  ...
  form.append('startDates[0]', document.getElementById('start-date1').value); // form.append('startDates[1]',document.getElementById('start-date2').value)
  ...
  form.append('startLocation.coordinates[1]', document.getElementById('start-location-co-ordinate2').value); // form.append('locations.description',document.getElementById('location1').value)
  ...
  form.append('images', document.getElementById('photo6').files[0]); // form.append('video',document.getElementById('videoa').files[0])

  form.append('description', document.getElementById('description').value);
  form.append('summary', document.getElementById('summary').value); // console.log(document.getElementById('videoa').files[0]);
...
if (tourUpdateForm) tourUpdateForm.addEventListener('submit', function (e) {
  ...
  form.append('startLocation.description', document.getElementById('start-location1').value); // form.append('difficulty',document.getElementById('difficulty').value)
  // form.append('maxGroupSize',document.getElementById('max-group-size').value)
